const LANGUAGE_NAMES = {
  de: {
    ...
    dashboardAddressInUse: (url) => `Start unter dieser Adresse nicht möglich: ${url}\n\nBeenden Sie den Prozess, der diese Adresse verwendet, oder wählen Sie einen anderen HOST bzw. PORT und versuchen Sie es erneut.`,
    dashboardAddressOccupied: "Adresse bereits belegt!",
  ...
  en: {
    ...
    dashboardAddressInUse: (url) => `Could not start at: ${url}\n\nStop the process using this address or choose a different HOST or PORT, then try again.`,
    dashboardAddressOccupied: "Address already in use!",
  ...
  es: {
    ...
    dashboardAddressInUse: (url) => `No se pudo iniciar en: ${url}\n\nDetenga el proceso que utiliza esta dirección o elija otro HOST o PORT e inténtelo de nuevo.`,
    dashboardAddressOccupied: "¡La dirección ya está en uso!",
  ...
  fr: {
    ...
    dashboardAddressInUse: (url) => `Démarrage impossible à l’adresse : ${url}\n\nArrêtez le processus qui utilise cette adresse ou choisissez un autre HOST ou PORT, puis réessayez.`,
    dashboardAddressOccupied: "Adresse déjà utilisée !",
  ...
  it: {
    ...
    dashboardAddressInUse: (url) => `Impossibile avviare all’indirizzo: ${url}\n\nArresta il processo che utilizza questo indirizzo oppure scegli un HOST o una PORT diversi e riprova.`,
    dashboardAddressOccupied: "Indirizzo già in uso!",
  ...
  ja: {
    ...
    dashboardAddressInUse: (url) => `このアドレスでは起動できませんでした: ${url}\n\nこのアドレスを使用しているプロセスを停止するか、別の HOST または PORT を選択して、もう一度お試しください。`,
    dashboardAddressOccupied: "アドレスはすでに使用されています！",
  ...
  pt: {
    ...
    dashboardAddressInUse: (url) => `Não foi possível iniciar em: ${url}\n\nTermine o processo que utiliza este endereço ou escolha outro HOST ou PORT e tente novamente.`,
    dashboardAddressOccupied: "O endereço já está a ser utilizado!",
  ...
  ru: {
    ...
    dashboardAddressInUse: (url) => `Не удалось запустить по адресу: ${url}\n\nОстановите процесс, использующий этот адрес, или выберите другой HOST либо PORT и повторите попытку.`,
    dashboardAddressOccupied: "Адрес уже используется!",
  ...
  zh: {
    ...
    dashboardAddressInUse: (url) => `无法在此地址启动：${url}\n\n请停止占用此地址的进程，或选择其他 HOST 或 PORT，然后重试。`,
    dashboardAddressOccupied: "地址已被占用！",
